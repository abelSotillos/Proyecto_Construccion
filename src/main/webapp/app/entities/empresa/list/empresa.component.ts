...
import { EmpresaService, EntityArrayResponseType } from '../service/empresa.service';
...
export class EmpresaComponent implements OnInit {
  ...
  trackId = (item: IEmpresa): number => this.empresaService.getEmpresaIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.empresas.set(dataFromBody);
  }
