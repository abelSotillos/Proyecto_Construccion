...
import { sampleWithRequiredData } from '../maquinaria.test-samples';
import { MaquinariaService } from '../service/maquinaria.service';

import { MaquinariaComponent } from './maquinaria.component';
import SpyInstance = jest.SpyInstance;

describe('Maquinaria Management Component', () => {
  let comp: MaquinariaComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MaquinariaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.maquinarias()[0]).toEqual(expect.objectContaining({ id: 27800 }));
  });

  describe('trackId', () => {
    it('Should forward to maquinariaService', () => {
      const entity = { id: 27800 };
      jest.spyOn(service, 'getMaquinariaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMaquinariaIdentifier).toHaveBeenCalledWith(entity);
